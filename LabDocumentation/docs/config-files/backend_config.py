...
### file location  /home/sunds/Code/TestApp/backend/config.py
#!/usr/bin/env python3
"""
...
- LLM Service (Ollama on Windows)
- PostgreSQL Database (Ubuntu VM)
...
class Config:
    ...
    LOG_FILE = os.environ.get('LOG_FILE', 'healthcare_security.log')
...
class DevelopmentConfig(Config):
    ...
    DATABASE_HOST = '192.168.0.235'
    DATABASE_NAME = 'healthcare_security'

    LLM_HOST = '192.168.0.169'
