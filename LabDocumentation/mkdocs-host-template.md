...
!!! info "Host Information"
    **Hostname:** frontend-backend-01  
    **IP Address:** 192.168.1.10  
    **Operating System:** Ubuntu 24.04 LTS  
    **Virtualization:** VMware Workstation 17.6.2 VM  
    **Hardware:** 12GB RAM, 2 vCPU, 100GB Storage  
...
cd /var/www/healthcare-frontend

# Initialize Vite app (if starting fresh)
npx create-react-app .

# Or clone your existing frontend
git clone [your-repo-url] /var/www/healthcare-frontend
cd /var/www/healthcare-frontend
...
- [:material-download: Flask .env Template](../config-files/flask-env-template.txt) - Environment variables template
